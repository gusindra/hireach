                                    ...
                                    <table class="min-w-full divide-y divide-gray-200">
                                        <tbody class="bg-white divide-y divide-gray-200">
                                            ...
                                            <tr class="border-none">
                                                ...
                                                <td class="pl-6">:</td>
                                                <td class="text-base whitespace-no-wrap">
                                                    {{ $data->date->format('d F Y') }} </td>
                                            </tr>
                                            <tr class="border-none">
                                                <td class="text-base whitespace-no-wrap"> Due Date </td>
                                                <td class="pl-6">:</td>
                                                <td class="text-base whitespace-no-wrap">
                                                    {{ $data->date->addDays(30)->format('d F Y') }} </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                                ...
                                <tr>
                                    <td class="pr-52">
                                        ...
                                        <table class="min-w-full divide-y divide-gray-200">
                                            <tbody class="bg-white divide-y divide-gray-200">
                                                <tr class="border-none">
                                                    <td class="text-sm whitespace-no-wrap font-bold uppercase">
                                                        {{ $data->user->name }} </td>
                                                </tr>
                                                <tr class="border-none">
                                                    <td class="text-sm whitespace-no-wrap"> {{ $data->user->address }}
                                                    </td>
                                                </tr>
                                                <tr class="border-none">
                                    ...
                                    <td class="align-top">
                                        ...
                                        <table class="min-w-full divide-y divide-gray-200">
                                            <tbody class="bg-white divide-y divide-gray-200">
                                                <tr class="border-none">
                                                    <td class="text-sm whitespace-no-wrap">
                                                ...
                                                @if ($data->vat > 0)
                                                    ...
                                                    <tr class="bg-gray-100">
                                                        <td class="px-1 py-2 text-xl whitespace-no-wrap text-right"
                                                            colspan="5" align="center">Total</td>
