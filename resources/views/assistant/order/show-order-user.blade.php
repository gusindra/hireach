                                        ...
                                        <div>
                                            ...
                                            <div>
                                                <div x-data="{
                                                    ...
                                                    @else
                                                        <div
                                                            class="print:hidden sticky top-1 right-1 left-1 p-2 flex text-right justify-between">

                                                            <button type="button" x-on:click="printDiv()"
                                                                class="text-xs bg-opacity-50 hover:bg-gray-300 text-gray-700 shadow-sm border px-2 py-1 rounded-sm bg-white flex items-center"><svg
                                                                    xmlns="http://www.w3.org/2000/svg"
                                                                    class="-ml-1 mr-1 h-5 w-5 text-gray-600" fill="none"
                                                    ...
                                                    <div class="bg-white overflow-hidden sm:rounded-lg">
                                                        <div x-ref="print" class="container mx-auto">
                                                            <div id="PRINT" class="text-xs">
                                                                        ...
                                                                        <div class="px-4 sm:px-0">
                                                                            @if ($data->company && $data->company->img_logo)
                                                                                ...
                                                                                <img style="height:100px;"
                                                                                    src="{{ url('/assets/img/logos/logo2.png') }}" />
                                                                            @else
                                                                                <h3
                                                                                    class="text-lg font-medium text-gray-900">
                                                                                    {{ $data->company ? $data->company->name : $data->entity_party }}
                                                                                </h3>
                                                                            @endif
                                                                        </div>
                                                                    </div>
                                                                            ...
                                                                            <table
                                                                                ...
                                                                                <tbody
                                                                                    ...
                                                                                    <tr class="border-none">
                                                                                        <td
                                                                                            class="text-base whitespace-no-wrap">
                                                                                            Invoice No </td>
                                                                                        <td class="pl-6">:</td>
                                                                                        <td
                                                                                            class="text-base whitespace-no-wrap">
                                                                                    ...
                                                                                    <tr class="border-none">
                                                                                        ...
                                                                                        <td
                                                                                            class="text-base whitespace-no-wrap">
                                                                                            {{ $data->date->addDays(30)->format('d F Y') }}
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
                                                                            ...
                                                                            <td class="pr-52">
                                                                                ...
                                                                                <table
                                                                                    ...
                                                                                    <tbody
                                                                                        ...
                                                                                        <tr class="border-none">
                                                                                            <td
                                                                                                class="text-sm whitespace-no-wrap font-bold uppercase">
                                                                                                {{ $data->user->name }}
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr class="border-none">
                                                                                ...
                                                                                <table
                                                                                    ...
                                                                                    <tbody
                                                                                        ...
                                                                                        <tr class="border-none">
                                                                                            <td
                                                                                                class="text-sm whitespace-no-wrap">
                                                                                                {{ $data->company ? $data->company->address : $data->entity_party }}
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr class="border-none">
                                                                                            <td
                                                                ...
                                                                <!-- Service -->
                                                                <div
                                                                    class="mt-5 md:mt-0 md:col-span-2 text-xl uppercase text-center">
                                                                    INVOICE
                                                                </div>
                                                                <div class="hidden">
                                                                    <div class="md:col-span-1 flex justify-between">
                                                                        <div class="px-4 sm:px-0">
                                                                            ...
                                                                            <table
                                                                                ...
                                                                                <tbody
                                                                                    ...
                                                                                    <tr class="border-none">
                                                                                        <td
                                                                                            class="px-6 text-sm whitespace-no-wrap">
                                                                ...
                                                                <div class="md:grid md:grid-cols-3 md:gap-2 my-4">
                                                                    ...
                                                                    <div class="md:mt-0 md:col-span-3">
                                                                        <div
                                                                            class="bg-white shadow sm:rounded-tl-md sm:rounded-tr-md">
                                                                            <div class="gap-6">
                                                                                <table
                                                                                    class="min-w-full divide-y divide-gray-200">
                                                                                    <thead>
                                                                                        <tr class="text-center">
                                                                                            <th
                                                                                                ...
                                                                                                No</th>
                                                                                            <th
                                                                                                class="px-3 py-2 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider w-1/3">
                                                                                                Description</th>
                                                                                            <th
                                                                                                class="px-3 py-2 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider w-1">
                                                                                                Price (IDR)</th>
                                                                                    ...
                                                                                    <tbody
                                                                                        ...
                                                                                        @foreach ($data->items as $item)
                                                                                            <tr class=" ">
                                                                                                <td
                                                                                                    class="px-3 py-1 whitespace-no-wrap">
                                                                                                    {{ $loop->iteration }}
                                                                                                </td>
                                                                                                <td
                                                                                                    class="px-3 py-1 whitespace-no-wrap">
                                                                                                    {{ $item->name }}<br><small>{{ $item->note }}</small>
                                                                                                </td>
                                                                                                <td
                                                                                                    class="px-3 py-1 whitespace-no-wrap text-right">
                                                                                                ...
                                                                                                <td
                                                                                                    class="px-3 py-1 whitespace-no-wrap text-center">
                                                                                                    {{ $item->total_percentage == 100 ? '' : '(' . $item->total_percentage . '%)' }}
                                                                                                </td>
                                                                                                <td
                                                                                                    class="px-3 py-1 whitespace-no-wrap text-right">
                                                                                                    {{ $item->total_percentage == 100 ? number_format($item->qty * $item->price) : number_format(($item->qty * $item->price * $item->total_percentage) / 100) }}
                                                                                                </td>
                                                                                            </tr>
                                                                                        @endforeach
                                                                                    </tbody>
                                                                                    <tfoot>
                                                                                        <tr class="bg-gray-100">
                                                                                            <td class="px-1 py-2 text-sm whitespace-no-wrap text-right"
                                                                                                colspan="5"
                                                                                                align="center">Sub
                                                                                                Total</td>
                                                                                            <td
                                                                                        ...
                                                                                        @if ($data->vat > 0)
                                                                                            <tr class="bg-gray-100">
                                                                                                <td class="px-1 py-2 text-xs whitespace-no-wrap text-right"
                                                                                                    colspan="5"
                                                                                                    align="center">VAT
                                                                                                    {{ '(' . $data->vat . '%)' }}
                                                                                                </td>
                                                                                            ...
                                                                                            <tr class="bg-gray-100">
                                                                                                <td class="px-1 py-2 text-xl whitespace-no-wrap text-right"
                                                                                                    colspan="5"
                                                                                                    align="center">
                                                                                                    Total</td>
                                                                                                <td
                                                                ...
                                                                <div class="md:grid md:grid-cols-3 my-4 p-3 border">
                                                                    <div class="md:mt-0 md:col-span-3">
                                                                        <strong
                                                                            class="">Description:</strong><br>
                                                                        <span
                                                                            class="font-bold">{{ $data->bill->description }}</span>
                                                                    </div>
                                                                </div>
                                                                <!-- Terms -->
                                                                <div>
                                                                    <div>
                                                                        <table
                                                                            ...
                                                                            <tbody
                                                                                ...
                                                                                <tr class="border-none">
                                                                                    <td
                                                                                        class="text-sm whitespace-no-wrap align-top">
                                                                                        <h3
                                                                                ...
                                                                                <tr>
                                                                                    <td
                                                                                        class="font-bold text-sm align-top flex justify-around1 justify-end">
                                                                                        <div
                                                                                            class="border border-gray-50 p-2 mb-2">
                                                    ...
                                                    @endforeach --}}
                                                                ...
                                                                <div class="flex justify-between my-4">
                                                                    ...
                                                                    <div class="justify-end flex p-4">
                                                                        <div
                                                                            class="items-center justify-end px-2 text-right">
                                                                            <table
                                                                                class="min-w-full divide-y divide-gray-200">
                                                                                <tbody
                                                                                    class="bg-white divide-y divide-gray-200">
                                                                                    <tr class="border-none">
                                                                                        {{-- <td class="font-bold text-sm whitespace-no-wrap">
                                                    {{ $data->company->person_in_charge }}</td> --}}
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
                                                                        </div>
