        ...
        <div x-data="{
            ...
            @else
                <div class="print:hidden sticky top-1 right-1 left-1 p-2 flex text-right justify-between">
                    <a href="{{ route('commercial.edit.show', ['key' => 'quotation', 'id' => $data->id]) }}"
                    ...
                    <button type="button" x-on:click="printDiv()"
                        class="text-xs bg-opacity-50 hover:bg-gray-300 text-gray-700 shadow-sm border px-2 py-1 rounded-sm bg-white flex items-center"><svg
                            xmlns="http://www.w3.org/2000/svg" class="-ml-1 mr-1 h-5 w-5 text-gray-600" fill="none"
                                ...
                                <td>
                                    <div class="px-4 sm:px-0">
                                        ...
                                        @elseif($data->model == 'PROJECT')
                                            ...
                                            @endif
                                        @else
                                            <h3 class="text-lg font-medium text-gray-900">{{ @$data->company->name }}
                                            </h3>
                                        @endif
                                    </div>
                                </td>
                            ...
                            <div class="md:col-span-1 flex justify-between">
                                <div class="px-4 sm:px-0">
                                    ...
                                    <table class="min-w-full divide-y divide-gray-200">
                                        <tbody class="bg-white divide-y divide-gray-200">
                                            <tr class="border-none">
                                                <td class="px-6 text-sm whitespace-no-wrap"> {!! nl2br($data->description) !!}
                                                </td>
                                                </td>
                                            </tr>
                                        </tbody>
                                        ...
                                        <table class="min-w-full divide-y divide-gray-200">
                                            ...
                                            <tbody class="bg-white divide-y divide-gray-200">
                                                @foreach ($data->items as $item)
                                                    <tr class=" ">
                                                        <td class="px-6 py-2 text-sm whitespace-no-wrap align-top">
                                                            {{ $loop->iteration }} </td>
                                                        <td class="px-6 py-2 text-sm whitespace-no-wrap align-top">
                                                            {{ $item->name }} </td>
                                                        <td
                                                        ...
                                                        <td class="px-2 py-2 text-sm whitespace-no-wrap flex">
                            ...
                            <div class="md:col-span-1 flex justify-between">
                                <div class="px-4 sm:px-0">
                                    ...
                                    <table class="min-w-full divide-y divide-gray-200">
                                        <tbody class="bg-white divide-y divide-gray-200">
                                            <tr class="border-none">
                                                <td class="px-6 text-sm whitespace-no-wrap"> {!! nl2br($data->terms) !!}
                                                </td>
                                                </td>
                                            </tr>
                                        </tbody>
