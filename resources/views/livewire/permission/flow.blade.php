    ...
    <x-jet-form-section submit="addFlow">
        ...
        <x-slot name="form">
            ...
            <div class="col-span-6 sm:col-span-3">
                ...
                <select name="input.role_id" id="input.role_id"
            ...
            <div class="col-span-6 sm:col-span-3">
                ...
                <select name="input.team_id" id="input.team_id"
                    class="border-gray-300 dark:bg-slate-800 dark:text-slate-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm mt-1 block w-full"
            ...
            <div class="col-span-6 sm:col-span-12">
                <div class="col-span-12 sm:col-span-1">
                    ...
                    <x-jet-input id="input.description" type="text" class="mt-1 block w-full"
                        wire:model="input.description" wire:model.defer="input.description"
                        wire:model.debunce.800ms="input.description" />
            ...
            <div class="col-span-6 sm:col-span-3">
                ...
                <select name="input.after_status" id="input.after_status"
                    class="border-gray-300 dark:bg-slate-800 dark:text-slate-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm mt-1 block w-full"
            ...
            <table class="table-auto text-xs sm:text-sm col-span-12">
                ...
                <tbody>
                    @foreach ($data as $d)
                        <tr>
                            <td
                                class="border border-light-blue-500 px-2 py-2 text-light-blue-600 font-medium text-center">
                                {{ $loop->iteration }} </td>
                            <td class="border border-light-blue-500 px-2 py-2 text-light-blue-600 font-medium w-1/5">
                                {{ $d->after_status }} </td>
                            <td class="border border-light-blue-500 px-2 py-2 text-light-blue-600 font-medium w-1/5">
                                {{ $d->result_status }} </td>
                            <td class="border border-light-blue-500 px-2 py-2 text-light-blue-600 font-medium w-3/4">
                                {{ $d->description }} </td>
                            <td class="border border-light-blue-500 px-2 py-2 text-light-blue-600 font-medium w-1/4">
                                {{ $d->role ? $d->role->name : '-' }}</td>
                            <td class="border border-light-blue-500 px-2 py-2 text-light-blue-600 font-medium">
                                {{ $d->team ? $d->team->name : '-' }} </td>
                            <td class="border border-light-blue-500 px-2 py-2 text-light-blue-600 font-medium">
                                <a href="#" class="text-red-400 px-2 underline"
                                    wire:click="deleteFlow({{ $d->id }})">Delete</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
