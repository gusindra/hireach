            ...
            <div class="col-span-6 sm:col-span-4">
                <div class="px-4 py-5 bg-white dark:bg-slate-600 sm:p-10">
                    ...
                    <div class="grid grid-cols-4 gap-3">
                        <button wire:click.prevent="onClickNominal(100000)" class="border {{$nominal==100000?'text-green-400 border-green-400':'border-gray-400'}} rounded-lg px-3 py-1 focus:border-green-400 focus:text-green-400 w-20 text-center">100rb</button>
    <button wire:click.prevent="onClickNominal(200000)" class="border {{$nominal==200000?'text-green-400 border-green-400':'border-gray-400'}} rounded-lg px-3 py-1 focus:border-green-400 focus:text-green-400 w-20 text-center">200rb</button>
    <button wire:click.prevent="onClickNominal(500000)" class="border {{$nominal==500000?'text-green-400 border-green-400':'border-gray-400'}} rounded-lg px-3 py-1 focus:border-green-400 focus:text-green-400 w-20 text-center">500rb</button>
    <button wire:click.prevent="onClickNominal(800000)" class="border {{$nominal==800000?'text-green-400 border-green-400':'border-gray-400'}} rounded-lg px-3 py-1 focus:border-green-400 focus:text-green-400 w-20 text-center">800rb</button>
    <button wire:click.prevent="onClickNominal(1000000)" class="border {{$nominal==1000000?'text-green-400 border-green-400':'border-gray-400'}} rounded-lg px-3 py-1 focus:border-green-400 focus:text-green-400 w-20 text-center">1jt</button>
    <button wire:click.prevent="onClickNominal(2000000)" class="border {{$nominal==2000000?'text-green-400 border-green-400':'border-gray-400'}} rounded-lg px-3 py-1 focus:border-green-400 focus:text-green-400 w-20 text-center">2jt</button>
    <button wire:click.prevent="onClickNominal(5000000)" class="border {{$nominal==5000000?'text-green-400 border-green-400':'border-gray-400'}} rounded-lg px-3 py-1 focus:border-green-400 focus:text-green-400 w-20 text-center">5jt</button>
    <button wire:click.prevent="onClickNominal(10000000)" class="border {{$nominal==10000000?'text-green-400 border-green-400':'border-gray-400'}} rounded-lg px-3 py-1 focus:border-green-400 focus:text-green-400 w-20 text-center">10jt</button>
                    </div>
                </div>
            </div>
        @endif
