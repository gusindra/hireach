    ...
    <div class="flex gap-4">
        <div class="flex-none">
            ...
            <div class="flex rounded-md shadow-sm">
                ...
                <input type="text" name="name" id="name"
                    ...
                    placeholder="Blade Name" wire:model="name" wire:model.defer="name" wire:model.debunce.800ms="name">
                <span
        ...
        <div class="flex-none">
            <input type="text" name="value" id="value"
                class="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-none sm:text-sm border-gray-300"
                placeholder="result,name" wire:model="value" wire:model.defer="value" wire:model.debunce.800ms="value">
