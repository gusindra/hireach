                    ...
                    <div class="flex flex-col">
                        <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                            <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                                ...
                                @else
                                    <div class="flex justify-between items-center bg-yellow-200 p-4 rounded-md animate-pulse">
                                        <div class="text-left w-full ">
                                            <p class="text-sm">User ini belum memilih <b>Provider</b>. Silahkan setting terlebih dahulu agar user dapat menggunakan service yang tersedia.</p>
                                        </div>
                                    </div>
                                @endif
                            </div>
