<div>
    <div class="flex items-center p-1 text-right">
        <a wire:click="actionShowModal" class="inline-flex hover:bg-gray-50 hover:bg-slate-600 cursor-pointer items-center px-3 py-2 text-gray-600 dark:bg-slate-800 border border-transparent rounded-md font-normal text-xs dark:text-white 1g-widest hover:text-slate-700 active:bg-green-900 focus:outline-none focus:border-gray-900 focus:shadow-outline-gray disabled:opacity-25 transition" wire:click="actionShowModal">
