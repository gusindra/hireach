        ...
        <x-slot name="form">
            ...
            <div class="col-span-6 sm:col-span-6">
                ...
                <x-textarea wire:model="description" wire:model.defer="description" value="description"
                    class="mt-1 block w-full" :disabled="!Gate::check('update', $role)"></x-textarea>
                <x-jet-input-error for="name" class="mt-2" />
            </div>
            ...
            <div class="col-span-6 grid grid-cols-2">
                ...
                <div class="col-span-12 sm:col-span-1">
                    ...
                    <select name="role_for" id="role_for"
                        class="border-gray-300 dark:bg-slate-800 dark:text-slate-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm mt-1 block w-full"
            ...
            <div class="col-span-6 sm:col-span-6">
                ...
                <div class="flex items-start">
                    <div class="flex items-center h-5">
                        <input id="status" name="status" wire:model="status" wire:model.defer="status"
                            type="checkbox"
