         ...
         <x-slot name="content">
             <div class="space-y-4">
                 <div>
                     ...
                     <x-jet-input id="valueEdit" type="text" class="mt-1 block w-full"
                         wire:model.defer="valueEdit" />
                     @error('valueEdit')
                 ...
                 <div>
                     ...
                     <x-jet-input id="remarkEdit" type="text" class="mt-1 block w-full"
                         wire:model.defer="remarkEdit" />
                     @error('remarkEdit')
                         <span class="text-red-500 text-sm">{{ $message }}</span>
                     @enderror
                 </div>
