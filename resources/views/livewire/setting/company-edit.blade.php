        ...
        <x-slot name="form">
            ...
            <div class="col-span-6 sm:col-span-4">
                <div class="col-span-12 sm:col-span-1">
                    ...
                    <x-jet-input id="person_in_charge" type="text" class="mt-1 block w-full" wire:model="input.person_in_charge" wire:model.defer="input.person_in_charge" wire:model.debunce.800ms="input.person_in_charge" />
