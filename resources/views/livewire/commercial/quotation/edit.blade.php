<div>
        ...
        <x-slot name="form">
            <div class="col-span-6 sm:col-span-4">
                <div class="col-span-12 sm:col-span-1">
                    ...
                    <x-jet-input id="name" disabled="{{ disableInput($quote->status) }}" type="text"
                        class="mt-1 block w-full" wire:model="name" wire:model.defer="name"
            ...
            <div class="col-span-6 sm:col-span-4">
                <div class="col-span-12 sm:col-span-1">
                    ...
                    <div class="flex justify-around">
                        <x-jet-input id="quoteNo" disabled="{{ disableInput($quote->status) }}" type="text"
                            class="mt-1 block w-full" wire:model="quoteNo" wire:model.defer="quoteNo"
            ...
            <div class="col-span-6 grid grid-cols-2">
                <div class="col-span-12 sm:col-span-1">
                    ...
                    <x-input.date-picker disabled="{{ disableInput($quote->status) }}" wire:model="date"
                        :error="$errors->first('date')" />
                    <x-jet-input-error for="date" class="mt-2" />
                </div>
                <div class="col-span-12 sm:col-span-1 md:mx-4">
                    <x-jet-label for="price" value="{{ __('Duration') }}" />
                    <select {{ disableInput($quote->status) ? 'disabled' : '' }} name="valid_day" id="valid_day"
            ...
            <div class="col-span-6 hidden grid grid-cols-2">
                <div class="col-span-12 sm:col-span-1">
                    <x-jet-label for="model" value="{{ __('Source') }}" />
                    <select {{ disableInput($quote->status) ? 'disabled' : '' }} name="model" id="model"
                        class="border-gray-300 dark:bg-slate-800 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm mt-1 block w-full"
                ...
                <div class="col-span-12 hidden sm:col-span-1 md:mx-4">
                    <x-jet-label for="model_id" value="{{ __('Source ID') }}" />
                    <select {{ disableInput($quote->status) ? 'disabled' : '' }} name="model_id" id="model_id"
                        class="border-gray-300 dark:bg-slate-800 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm mt-1 block w-full"
            ...
            <div class="col-span-6 grid grid-cols-2">
                @if ($source == 'project')
                    ...
                    <div class="col-span-12 sm:col-span-1">
                        ...
                        <p class="border rounded-md shadow-sm mt-1 block w-full p-2">
                            {{ $quote->client->name }}</p>
                    </div>
                ...
                @else
                    <div class="col-span-12 sm:col-span-1">
                        ...
                        @else
                            <x-jet-input id="addressed_company" disabled="{{ disableInput($quote->status) }}"
                                type="text" class="mt-1 block w-full" wire:model="addressed_company"
                                wire:model.defer="addressed_company" wire:model.debunce.800ms="addressed_company" />
                    ...
                    <div class="col-span-12 sm:col-span-1 md:mx-4">
                        ...
                        <select {{ disableInput($quote->status) ? 'disabled' : '' }} wire:change="onChangeModelId"
    ...
    <x-jet-form-section submit="update({{ $quote->id }})">
        ...
        <x-slot name="form">
            ...
            <div class="col-span-6 sm:col-span-6">
                ...
                <x-textarea disabled="{{ disableInput($quote->status) }}" wire:model="description"
                    wire:model.defer="description" value="description"
                    class="mt-1 block w-full h-32 text-sm"></x-textarea>
    ...
    <x-jet-form-section submit="update({{ $quote->id }})">
        ...
        <x-slot name="form">
            <!-- Description -->
            <div class="col-span-6 sm:col-span-6">
                <x-textarea wire:model="terms" disabled="{{ disableInput($quote->status) }}"
                    wire:model.defer="terms" value="terms" class="mt-1 block w-full h-32 text-sm"
                    placeholder="ex: * Price exclude PPn 10%"></x-textarea>
        ...
        <x-slot name="form">
            ...
            <div class="col-span-6 grid grid-cols-2">
                <div class="col-span-12 sm:col-span-1 md:mx-4">
                    ...
                    <x-jet-input id="created_role" disabled="{{ disableInput($quote->status) }}" type="text"
                        class="mt-1 block w-full" wire:model="created_role" wire:model.defer="created_role"
                ...
                <div class="col-span-12 sm:col-span-1 md:mx-4">
                    ...
                    <x-jet-input id="addressed_name" disabled="{{ disableInput($quote->status) }}" type="text"
                        class="mt-1 block w-full" wire:model="addressed_name" wire:model.defer="addressed_name"
                        wire:model.debunce.800ms="addressed_name" placeholder="Customer Name" />
                    <x-jet-input-error for="addressed_name" class="mt-2" />
                    <x-jet-input id="addressed_role" disabled="{{ disableInput($quote->status) }}" type="text"
                        class="mt-1 block w-full placeholder-gray-500" wire:model="addressed_role"
                        wire:model.defer="addressed_role" wire:model.debunce.800ms="addressed_role"
                        placeholder="Role" />
                    <x-jet-input-error for="addressed_role" class="mt-2" />
                    <x-jet-input id="addressed_company" disabled="{{ disableInput($quote->status) }}" type="text"
                        class="mt-1 block w-full placeholder-gray-500" wire:model="addressed_company"
                        wire:model.defer="addressed_company" wire:model.debunce.800ms="addressed_company"
                        placeholder="Company" />
                    <x-jet-input-error for="addressed_company" class="mt-2" />
                </div>
    ...
    @if ($quote->status == 'draft')
        <div class="grid ml-5 grid-cols-2 gap-4 mt-6 shadow p-4">
            <div class="">
                <h2 class="text-lg">Delete Quotation</h2>
        ...
        <x-jet-dialog-modal class="text-left" wire:model="modalDeleteVisible">
            ...
            <x-slot name="content">
                <p>{{ __('Are you sure you want to delete this quotation?') }}</p>
            </x-slot>
