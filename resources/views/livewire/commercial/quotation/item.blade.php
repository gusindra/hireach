                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th
                                                    ...
                                                    Desc</th>
                                                <th
                                                    class="px-6 py-3 bg-gray-50 dark:bg-slate-800 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider w-1/4 {{ $data->status == 'draft' ? '' : 'hidden' }}">
                                                </th>
                                            </tr>
                                        </thead>
                                                    ...
                                                    <td
                                                        ...
                                                        <div class="items-center flex">
                                                            <button title="{{ __('Edit') }}"
                                                                class="cursor-pointer m-2 w-auto text-xs p-1 bg-yellow-200 text-gray-800 rounded"
        ...
        <x-slot name="content">
            ...
            <div class="col-span-6 sm:col-span-4 p-3 grid grid-cols-3">
                ...
                <div class="mx-3">
                    ...
                    <x-jet-input id="qty" type="text" class="mt-1 block w-full" wire:model.debunce.800ms="qty"
                        autofocus />
                    <x-jet-input-error for="qty" class="mt-2" />
                </div>
                <div class="mx-3">
                    <x-jet-label for="unit" value="{{ __('Unit Measurement') }}" />
                    <x-jet-input id="unit" placeholder="item / meter / kg / etc" type="text"
