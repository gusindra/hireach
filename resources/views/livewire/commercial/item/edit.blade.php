        ...
        <x-slot name="form">
            <div class="col-span-6 grid grid-cols-2">
                <div class="col-span-12 sm:col-span-1">
                    ...
                    <x-jet-input id="sku" type="text" class="mt-1 block w-full" wire:model="sku"
                        wire:model.defer="sku" wire:model.debunce.800ms="sku" />
    ...
    <x-jet-form-section submit="update({{ $item->id }})">
        ...
        <x-slot name="form">
            ...
            <div class="col-span-6 sm:col-span-6">
                ...
                <x-textarea wire:model="spec" wire:model.defer="spec" value="spec"
                    class="mt-1 block w-full"></x-textarea>
                <x-jet-input-error for="name" class="mt-2" />
            </div>
        </x-slot>
        ...
        <x-slot name="form">
            ...
            <div class="col-span-6 grid grid-cols-2">
                <div class="col-span-12 sm:col-span-1">
                    ...
                    <x-jet-input id="price" type="text" class="mt-1 block w-full" wire:model="price"
                        wire:model.defer="price" wire:model.debunce.800ms="price" />
                    <x-jet-input-error for="price" class="mt-2" />
                </div>
                @if ($item->type == 'nosku')
                    <div class="col-span-10 sm:col-span-1 mx-4">
                        <x-jet-label for="unit" value="{{ __('Unit') }}" />
                        <x-jet-input id="unit" type="text" class="mt-1 block w-full" wire:model="unit"
                            wire:model.defer="unit" wire:model.debunce.800ms="unit" />
            ...
            <div class="col-span-6 grid grid-cols-2">
                <div class="col-span-12 sm:col-span-1">
                    ...
                    <x-jet-input id="discount" type="text" class="mt-1 block w-full" wire:model="discount"
                        wire:model.defer="discount" wire:model.debunce.800ms="discount" />
