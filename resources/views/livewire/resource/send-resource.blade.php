<div>
        ...
        <div class="w-full mx-auto p-3 px-3">
            <div class="flex items-center justify-between flex-wrap">
                ...
                <div class="order-2 flex-shrink-0 sm:order-3 sm:ml-3">
                    <button type="button" class="flex items-center my-auto p-3 text-xs text-white bg-indigo-800 rounded-md hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-white">
                        SEND
        ...
        <x-slot name="form">
            ...
            <div class="col-span-2 p-3 bg-gray-100 border-1 rounded-lg space-y-3">
                ...
                <div class="col-span-6 sm:col-span-4">
                    ...
                    <p class="text-gray-500 dark:text-slate-300 text-xs text-right m-2">Sending price is on Provider</p>
                ...
                <div class="col-span-6 sm:col-span-6">
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="ml-3 text-sm">
                            <label for="is_enabled" class="font-medium text-gray-700 dark:text-slate-300">Sending OTP (One Time Password) ?</label>
    ...
    <x-jet-form-section submit="updateTemplate">
        ...
        <x-slot name="form">
            <!-- Template Name -->
            <div class="col-span-6 sm:col-span-6">
                <x-jet-label for="name" value="{{ __('From') }}" />
                <x-jet-input id="name"
                            type="text"
                            class="mt-1 block w-full"
                            wire:model="name"
