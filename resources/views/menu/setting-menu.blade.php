<div class="absolute bottom-0 left-0 justify-center px-4 w-full dark:bg-gray-800 z-20 border-r border-gray-200 dark:border-gray-700">
    <div class="pt-4 mt-2 space-y-2 border-t border-gray-200 dark:border-gray-700">
        <div class="text-center flex justify-center items-center">
            <a href="{{ route('profile.show') }}"
                class="w-full h-12 inline-justify-center p-2 text-gray-500 rounded cursor-pointer dark:text-gray-400 hover:text-gray-900 dark:hover:text-black hover:bg-gray-100 dark:hover:bg-gray-800">
                <center>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="h-6 h-6">
    ...
    <div class="hidden pt-2 mt-2 space-y-2 border-t border-gray-200 dark:border-gray-700">
        <div class="text-center flex justify-center items-center">
            <a href="#" data-tooltip-target="tooltip-settings"
                class="inline-justify-center p-2 text-gray-500 rounded cursor-pointer dark:text-gray-400 dark:hover:text-black hover:text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-800">
                <center>
    ...
    <div class="pb-2 mb-2 space-y-2 border-gray-200 dark:border-gray-700">
        <div class="text-center flex justify-center items-center">
            <form method="POST" action="{{ route('logout') }}">
                ...
                <div data-tooltip-target="tooltip-settings"
                    ...
                    <center>
                    <x-jet-dropdown-link href="{{ route('logout') }}" title="logout"
    ...
    <button type="button" data-dropdown-toggle="language-dropdown"
        class="hidden inline-justify-center p-2 text-gray-500 rounded cursor-pointer dark:hover:text-white dark:text-gray-400 hover:text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-600">
