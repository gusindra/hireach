            ...
            <div class="p-6 bg-white border-b border-gray-200">
                ...
                <form action="{{ route('contacts.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <select id="title" name="title" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                            <option selected disabled>Pilih Title</option>
                            <option>Mr.</option>
                            <option>Mrs.</option>
                            <option>Miss</option>
