        ...
        <div class="col-span-12 px-2 ml-24 mt-2">
            <header class="bg-white dark:bg-slate-900 flex">
                ...
                <ul
                    ...
                    <li class="me-2">
                        <a href="{{ route('contact.index') }}" aria-current="page"
                            class="inline-block p-4 text-blue-600 bg-gray-100 rounded-t-lg active dark:bg-gray-800 dark:text-blue-500">Contact</a>
                    </li>
                    <li class="me-2">
                        <a href="{{ route('audience.index') }}"
                            class="inline-block p-4 rounded-t-lg hover:text-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 dark:hover:text-gray-300">Audience</a>
                    </li>
                    <li class="me-2">
