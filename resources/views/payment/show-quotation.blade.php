                                                    ...
                                                    @else
                                                        <div
                                                            ...
                                                            @if ($data->status == 'approved')
                                                                <a href="{{ route('quotation', ['key' => 'quotation', 'id' => $data->id]) }}"
                                                                    class="text-xs bg-opacity-50 bg-gray-100 text-gray-700 px-2 py-1 rounded-sm hover:bg-gray-300 flex items-center">Back</a>
                                                                <button type="button" x-on:click="printDiv()"
                                                                    class="text-xs bg-opacity-50 hover:bg-gray-300 text-gray-700 shadow-sm border px-2 py-1 rounded-sm bg-white flex items-center"><svg
                                                                        ...
                                                                        class="-ml-1 mr-1 h-5 w-5 text-gray-600"
...
@endif-->
                                                                ...
                                                                <table class="min-w-full divide-y divide-gray-200">
                                                                    <tr>
                                                                                ...
                                                                                @if ($data->model == 'COMPANY')
                                                                                    @if ($data->company && $data->company->img_logo)
                                                                                        <img style="height:100px;"
                                                                                            src="https://telixcel.s3.ap-southeast-1.amazonaws.com/{{ $data->company->img_logo->file }}" />
                                                                                    @endif
                                                                                @elseif($data->model == 'PROJECT')
                                                                                    @if ($data->project->company && $data->project->company->img_logo)
                                                                                        <img style="height:100px;"
                                                                                            src="https://telixcel.s3.ap-southeast-1.amazonaws.com/{{ $data->project->company->img_logo->file }}" />
                                                                                    @endif
                                                                                @else
                                                                                    <h3
                                                                        ...
                                                                        <td>
                                                                            <div
                                                                                class="mt-5 md:mt-0 md:col-span-2 uppercase text-left">
                                                                                    ...
                                                                                    <thead>
                                                                                        <tr>
                                                                                            <th
                                                                                                ...
                                                                                                No</th>
                                                                                            <th
                                                                                                class="px-6 py-3 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider w-1/2">
                                                                                                Item</th>
                                                                                            <th
                                                                                                class="px-6 py-3 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider w-1">
                                                                                                Price (IDR)</th>
                                                                                            <th
                                                                                                class="px-6 py-3 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider w-2">
                                                                                                Unit</th>
                                                                                            <th
                                                                                                class="px-6 py-3 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider w-1/4">
                                                                                                Desc</th>
                                                                                        </tr>
                                                                                    </thead>
                                                                                    <tbody
                                                                                        ...
                                                                                        @foreach ($data->items as $item)
                                                                                            <tr class=" ">
                                                                                                <td
                                                                                                    class="px-6 py-2 text-sm whitespace-no-wrap align-top">
                                                                                                    {{ $loop->iteration }}
                                                                                                </td>
                                                                                                <td
                                                                                                    class="px-6 py-2 text-sm whitespace-no-wrap align-top">
                                                                                                ...
                                                                                                <td
                                                                                                    class="px-2 py-2 text-sm whitespace-no-wrap text-right align-top">
                                                                                                    {{ number_format($item->price) }}
                                                                                                </td>
                                                                                                <td
                                                                                                    class="px-2 py-2 text-sm whitespace-no-wrap flex">
                                                                                                    {{ $item->qty > 0 ? $item->qty : '' }}
                                                                                                    {{ $item->unit }}
                                                                                                </td>
                                                                                                <td
                                                                ...
                                                                <!-- Duration -->
                                                                <div
                                                                    class="md:grid md:grid-cols-3 md:gap-6 my-4 p-3 border">
                                                                    <div class="md:col-span-3 text-center font-bold">
                                                                        This Quotation Valid for {{ $data->valid_day }}
                                                                        days
                                                                    </div>
                                                                </div>
                                                                <!-- Terms -->
                                                                ...
                                                                <div class="flex justify-between my-4">
                                                                    ...
                                                                    <div class="justify-end flex p-4">
                                                                        <div
                                                                            ...
                                                                            <p class="text-gray-900">I, hereby accept
                                                                                the quotation</p>
                                                                            <br>
                                                                            <br>
                                                                            <br>
                        ...
                        <div class="col-span-1">
                            <div class="justify-between lg:visible md:invisible">
                                @livewire('commercial.progress', ['model' => 'quotation', 'id' => $data->id])
                            </div>
                        </div>
