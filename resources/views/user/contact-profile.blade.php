    ...
    <div class="grid grid-cols-12">
        <aside id="default-sidebar" class="dark:text-white w-24 mt-16 col-span-1 left-0 z-40 transition-transform -translate-x-full sm:translate-x-0 fixed overflow-y-auto lg:block inset-0 bg-white" aria-label="Sidenav">
            <div class="overflow-y-auto py-2 px-2 h-full bg-white dark:bg-slate-800 border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700">
                <ul class="space-y-2">
                    <li>
                        <a href="{{route('user.index')}}" type="button" class="{{url()->full()==route('user.index')?'bg-slate-100':''}} items-center p-2 w-full text-base font-normal text-gray-600 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-slate-700" aria-controls="dropdown-pages" data-collapse-toggle="dropdown-pages">
                            <center>
                    ...
                    <li>
                        <a href="{{route('resources.index')}}?resource=1" type="button" class="{{request ()->get('resource')==1?'bg-slate-100':''}} items-center p-2 w-full text-base font-normal text-gray-600 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-slate-700" aria-controls="dropdown-pages" data-collapse-toggle="dropdown-pages">
                            <center>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                    ...
                    <li>
                        <a href="{{route('resources.index')}}?resource=2" type="button" class="{{request ()->get('resource')==2?'bg-slate-100':''}} items-center p-2 w-full text-base font-normal text-gray-600 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-slate-700" aria-controls="dropdown-pages" data-collapse-toggle="dropdown-pages">
                            <center>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                ...
                <div class="mx-auto py-3 px-4 sm:px-6 lg:px-2">
                    <div class="font-semibold text-xl text-gray-800 dark:text-slate-300 leading-tight flex justify-between">
                        ...
                        <div class="flex gap-3">
                            <a href="#">{{ __('Balance') }} : <span class="capitalize">Rp {{number_format(balance(auth()->user()))}}</span></a>3
