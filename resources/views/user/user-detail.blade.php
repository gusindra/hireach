                                    ...
                                    <div class="bg-white dark:bg-slate-600 overflow-hidden shadow-xl sm:rounded-lg">
                                        <div class="p-2 border-b border-gray-200">
                                            ...
                                            <form method="get" action="{{ url('/user/' . $user->id) }}">
                                                <select class="dark:bg-slate-800 dark:text-slate-300" name="month"
                                                    id="month">
                                                    <option
                                                ...
                                                <select class="dark:bg-slate-800 dark:text-slate-300" name="year"
                                                    id="year">
                                                ...
                                                <button type="submit"
                                                    class="px-2 py-1 bg-gray-800 text-white">Show</button>
                                            </form>
                                        </div>
