<aside mini="false"
    class="dark:bg-gray-950 ease-soft-in-out z-990 max-w-64 dark: fixed inset-y-0 left-0 my-4 xl:ml-4 block w-full -translate-x-full flex-wrap items-center justify-between overflow-y-auto rounded-2xl border-0 bg-white p-0 shadow-none transition-all duration-200 xl:translate-x-0 xl:bg-transparent z-10"
    id="sidenav-main">
    <div class="h-20">
        ...
        <a class="block px-2 pt-4 m-0 text-sm whitespace-nowrap text-slate-700 dark:text-white text-center" href="/"
            target="_blank">
            <img src="https://telixcel.s3.ap-southeast-1.amazonaws.com/imgs/logo-150.png"
                class="inline-block h-full max-w-full transition-all duration-200 ease-soft-in-out max-h-8 dark:hidden"
                alt="main_logo" />
            <img src="https://telixcel.s3.ap-southeast-1.amazonaws.com/imgs/logo-white-200.png"
    ...
    <div class="items-center block w-full h-auto grow basis-full" id="sidenav-collapse-main">
        ...
        <ul class="flex flex-col pl-0 mb-0 list-none">
            <li class="mt-0.5 w-full">
                <a active_primary href="{{ route('dashboard') }}?v=1" data-route="dashboard"
                    ...
                    aria-expanded="false">
                    <div
                        class="{{request()->routeIs('dashboard')?'bg-gradient-to-tl from-gray-900 to-slate-800':''}} stroke-none shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center fill-current p-2.5 text-center text-black">
                    ...
                    <span
                        class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft {{request()->routeIs('dashboard')?'text-slate-700':''}}">Dashboards</span>
                </a>
            </li>
            ...
            <li class="mt-0.5 w-full">
                <a collapse_trigger="primary" href="{{ route('user.index') }}?v=1"
                    ...
                    <div
                        class="{{request()->routeIs('user.index')?'bg-gradient-to-tl from-gray-900 to-slate-800':''}} stroke-none shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center fill-current p-2.5 text-center text-black">
                                ...
                                <g transform="translate(-1717.000000, -291.000000)" fill="#FFFFFF" fill-rule="nonzero">
                                    <g transform="translate(1716.000000, 291.000000)">
                                        <g transform="translate(1.000000, 0.000000)">
                                            <path class="{{request()->routeIs('user.index')?'':'fill-slate-800'}}"
                    ...
                    <span
                        class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft {{request()->routeIs('user.index')?'text-slate-700':''}}">Users</span>
                </a>
            </li>

            <li class="mt-0.5 w-full">
                <a collapse_trigger="primary" href="{{ route('project') }}?v=1"
                    class="{{request()->routeIs('project')?'rounded-lg bg-white xl:shadow-soft-xl font-semibold text-slate-700':'font-medium text-slate-500'}} ease-soft-in-out text-sm py-2.7 active after:ease-soft-in-out after:font-awesome-5-free my-0 mx-4 flex items-center whitespace-nowrap px-4 font-medium text-slate-500 shadow-none transition-colors after:ml-auto after:inline-block after:font-bold after:text-slate-800/50 after:antialiased after:transition-all after:duration-200 dark:text-white dark:opacity-80 dark:after:text-white/50 dark:after:text-white"
                    aria-controls="applicationsExamples" role="button" aria-expanded="false">
                    <div
                        class="{{request()->routeIs('project')?'bg-gradient-to-tl from-gray-900 to-slate-800':''}} stroke-none shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center fill-current p-2.5 text-center text-black">
                                ...
                                <g transform="translate(-1720.000000, -592.000000)" fill="#FFFFFF" fill-rule="nonzero">
                                    <g transform="translate(1716.000000, 291.000000)">
                                        <g transform="translate(4.000000, 301.000000)">
                                            <path class="{{request()->routeIs('project')?'':'fill-slate-800'}}"
                    ...
                    <span
                        class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft {{request()->routeIs('project')?'text-slate-700':''}}">Projects</span>
                </a>
            </li>

            <li class="mt-0.5 w-full">
                <a collapse_trigger="primary" href="{{ route('billing') }}?v=1"
                    class="{{request()->routeIs('billing')?'rounded-lg bg-white xl:shadow-soft-xl font-semibold text-slate-700':'font-medium text-slate-500'}} ease-soft-in-out text-sm py-2.7 active after:ease-soft-in-out after:font-awesome-5-free my-0 mx-4 flex items-center whitespace-nowrap px-4 font-medium text-slate-500 shadow-none transition-colors after:ml-auto after:inline-block after:font-bold after:text-slate-800/50 after:antialiased after:transition-all after:duration-200 dark:text-white dark:opacity-80 dark:after:text-white/50 dark:after:text-white"
                    aria-controls="ecommerceExamples" role="button" aria-expanded="false">
                    <div
                        class="{{request()->routeIs('billing')?'bg-gradient-to-tl from-gray-900 to-slate-800':''}} stroke-none shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center fill-current p-2.5 text-center text-black">
                                ...
                                <g transform="translate(-1870.000000, -591.000000)" fill="#FFFFFF" fill-rule="nonzero">
                                    <g transform="translate(1716.000000, 291.000000)">
                                        <g transform="translate(154.000000, 300.000000)">
                                            <path class="{{request()->routeIs('billing')?'':'fill-slate-800'}}"
                    ...
                    <span
                        class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft {{request()->routeIs('billing')?'text-slate-700':''}}">Billings</span>
                </a>
            </li>
            ...
            <li class="mt-0.5 w-full">
                <h6 class="my-4 pl-6 mb-2 ml-2 font-bold leading-tight uppercase text-xs opacity-60 dark:text-white">
                    SETTINGS</h6>
            </li>
                                ...
                                <g transform="translate(-2020.000000, -442.000000)" fill="#FFFFFF" fill-rule="nonzero">
                                    <g transform="translate(1716.000000, 291.000000)">
                                        <g transform="translate(304.000000, 151.000000)">
                                            <polygon class="{{request()->routeIs('project')?'':'fill-slate-800'}}"
                                                opacity="0.596981957"
                        ...
                        <li class="w-full">
                            <a collapse_trigger="secondary"
                                ...
                                <span
                                    ...
                                    G </span>
                                <span class="transition-all duration-100 pointer-events-none ease-soft"> User <b
                                        class="caret"></b></span>
                            </a>
                            <div class="h-auto overflow-hidden transition-all duration-200 ease-soft-in-out max-h-0"
                                ...
                                <ul
                                    ...
                                    <li class="w-full">
                                        <a class="ease-soft-in-out py-1.6 ml-5.4 pl-4 text-3.4 relative my-0 mr-4 flex items-center whitespace-nowrap bg-transparent pr-4 font-medium text-slate-800/50 shadow-none transition-colors dark:text-white dark:opacity-60"
                                            href="{{route('payment.deposit')}}?v=1">
                                            <span
                                                class="w-0 leading-tight text-center transition-all duration-200 opacity-0 pointer-events-none text-xs ease-soft-in-out">
                                                L </span>
                                            <span class="transition-all duration-100 pointer-events-none ease-soft">
                        ...
                        <li class="w-full">
                            <a collapse_trigger="secondary"
                                ...
                                <span
                                    class="w-0 text-center transition-all duration-200 opacity-0 pointer-events-none ease-soft-in-out">
                                    F </span>
                                <span class="transition-all duration-100 pointer-events-none ease-soft"> Advance <b
                                        class="caret"></b></span>
                            </a>
                            <div class="h-auto overflow-hidden transition-all duration-200 ease-soft-in-out max-h-0"
            ...
            <li class="mt-0.5 w-full">
                ...
                <a href="{{ route('logout') }}"
                    class="ease-soft-in-out text-sm py-2.7 active my-0 mx-4 flex items-center whitespace-nowrap px-4 font-medium text-slate-500 shadow-none transition-colors dark:text-white dark:opacity-80">
                    <div
                        class="stroke-none shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center fill-current p-2.5 text-center text-black">
                    ...
                    <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">{{ __('Log Out') }}</span>
                </a>
            </li>
            <!-- <li class="mt-0.5 w-full">
    ...
    <div class="pt-4 mx-4 mt-4">
        ...
        <div sidenav-card
            class="dark:bg-gray-950/80 after:opacity-65 after:bg-gradient-to-tl after:from-slate-600 after:to-slate-300 relative flex min-w-0 flex-col items-center break-words rounded-2xl border-0 border-solid border-blue-900 bg-white bg-clip-border shadow-none after:absolute after:top-0 after:bottom-0 after:left-0 after:z-10 after:block after:h-full after:w-full after:rounded-2xl after:content-[''] hidden">
            <div class="relative z-20 flex-auto w-full p-4 text-left text-white">
                <div
                    class="items-center justify-center w-8 h-8 mb-4 text-center bg-white bg-center rounded-lg icon shadow-soft-2xl hidden">
                    <i sidenav-card-icon=""
                ...
                <div class="transition-all duration-200 ease-nav-brand">
                    ...
                    <a href="https://www.creative-tim.com/learning-lab/tailwind/html/quick-start/soft-ui-dashboard/"
                        target="_blank"
                        class="inline-block w-full px-8 py-2 mb-0 font-bold text-center text-black uppercase transition-all ease-in bg-white border-0 border-white rounded-lg shadow-soft-md bg-150 leading-pro text-xs hover:shadow-soft-2xl hover:scale-102">Chat
                        Us</a>
                </div>
            </div>
        </div>
