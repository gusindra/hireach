    ...
    <div class="flex items-center justify-between w-full px-6 py-1 mx-auto flex-wrap-inherit">
        <nav>
            <ol class="flex flex-wrap pt-1 pr-4 mr-12 bg-transparent rounded-lg sm:mr-16">
                <li class="text-sm pl-2 capitalize leading-normal before:float-left before:pr-2" aria-current="page">My Project</li>
            </ol>
...
<div class="w-full p-6 mx-auto">
    <section class="py-4">
        ...
        <livewire:table.project-table searchable="name" companyid="{{auth()->user()->team->team->user->company->id}}" exportable />
    </section>
</div>
@else
<div class="w-full p-6 mx-auto">
            ...
            <div class="w-full max-w-full px-3 mb-6 md:flex-0 shrink-0 md:w-6/12 lg:w-4/12">
                <div class="relative flex flex-col h-full min-w-0 break-words bg-white border-0 dark:bg-gray-950 dark:shadow-soft-dark-xl shadow-soft-xl rounded-2xl bg-clip-border">
                    <div class="flex flex-col justify-center flex-auto p-6 text-center">
                        <div class="text-slate-400 text-lg cursor-pointer">
                            ...
                            <div class="flex-auto p-4">
                                <div class="flex">
                                    ...
                                    <div class="my-auto ml-4">
                                        ...
                                        <div>
                                            <a href="javascript:;" class="relative inline-flex items-center justify-center w-6 h-6 text-white transition-all duration-200 border-2 border-white border-solid ease-soft-in-out text-xs rounded-circle hover:z-30" data-target="tooltip_trigger" data-popper-placement="top">
                                            ...
                                            <div class="hidden px-2 py-1 text-white bg-black rounded-lg text-sm" id="tooltip" role="tooltip" data-popper-placement="top">
                                                Elena Morison
