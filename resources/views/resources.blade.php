<x-app-layout>
    ...
    <div class="grid grid-cols-12">
        <aside id="default-sidebar" class="dark:text-white col-span-1 top-0 left-0 z-40 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidenav">
        ...
        <div class="col-span-11">
            <div class="bg-white dark:bg-slate-600  overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="m-4">
                    @if(request ()->get('resource')==1)
                        <div>
                            <livewire:table.sms-blast-table hide-header searchable="name, description" resource="{{request ()->get('resource')}}" />
                        </div>
                    @elseif(request ()->get('resource')==2)
                        <div>
