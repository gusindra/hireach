        ...
        <div class="grid grid-cols-12">
            ...
            <div class="col-span-12 px-6 ml-24 mt-2">
                <div class="bg-white dark:bg-slate-600 overflow-hidden sm:rounded-lg">
                        ...
                        <ul
                            ...
                            <li class="me-2">
                                <a href="{{ route('dashboard.outbound') }}"
                                    class="inline-block p-4 rounded-t-lg hover:text-gray-600 active hover:bg-gray-50 dark:hover:bg-gray-800 dark:hover:text-gray-300">Out
                                    Bound</a>
                            </li>

                            <li class="me-2">
                                <a href="{{ route('dashboard.outbound.blast-message') }}" aria-current="page"
                                    class="inline-block p-4 text-blue-600 bg-gray-100 rounded-t-lg  dark:bg-gray-800 dark:text-blue-500">Blast
                                    Message</a>
                            </li>
                    ...
                    <div>
                        <livewire:table.sms-blast-table searchable="name, description" exportable />
                    </div>
